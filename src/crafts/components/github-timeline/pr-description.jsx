...
export default function PullRequestDescription({ description, author }) {
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {"commented on " +
              author?.timestamp?.date +
              " " +
              author?.timestamp?.month +
              (author?.timestamp?.month && author?.timestamp?.year && ", ") +
              author?.timestamp?.year}
          </span>
        </div>
      </div>
      <div
      ...
      >
        <div
          className={cn("pr-description-container__description-body-container")}
        >
          ...
          {!description && (
            <div className={cn("no-description-found-labeler")}>
              ...
              <span className={cn("no-description-found-sr-text sr-only")}>
            ...
            <div className={cn("description-body-content")}>
              {typeof description === "string" && (
                <div className={cn("description-content-wrapper")}>
                  ...
                  <span className={cn("description-content-sr-text sr-only")}>
                    {description}
                  </span>
                </div>
              )}
                ...
                (descriptionElement, descriptionElementIndex) => {
                  switch (descriptionElement?.type) {
                    ...
                    case "text":
                      ...
                      return (
                        <p
                          className={cn("text-base font-normal my-2")}
                          key={descriptionElementIndex}
                        >
                          {descriptionElement?.content}
                        </p>
