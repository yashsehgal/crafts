  ...
  return (
    <div className="spotify-lyrics-slider-component-container">
      ...
      <div className="spotify-lyrics-slider-component">
        <AnimatePresence>
          <motion.div
            className="song-lyrics-wrapper my-12 min-w-[240px] max-w-[420px] w-fit h-[240px] bg-gray-200 rounded-md shadow-inner p-2 overflow-y-scroll"
            id="lyrics-container"
          >
            {renderLyrics({
        ...
        <div className="music-details-wrapper mt-4 flex flex-row items-center justify-between px-2">
          <div className="flex flex-row items-center gap-3">
            ...
            <div className="music-text-details-wrapper">
              <h3 className="music-name leading-snug font-medium text-xl w-56 truncate" 
                aria-label={SongDetails.songName} 
        ...
        <div className="activity-actions-wrapper mt-4">
          <span className={cn("admin-playing-status font-medium", 
            isPlaying ? "text-green-600 animate-pulse" : "text-gray-500")} >
            {`yash ${isPlaying ? "is vibing..." : "has paused music"}`}
          </span>
        </div>
      </div>
    </div>
